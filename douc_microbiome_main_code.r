...
pdf("results/bray.pdf",width=6,height=4.75); plot_pcoa(bray,map,category='Lifestyle');
pdf("results/uuf.pdf",width=6,height=4.75); pcoa.u = plot_unifrac(otu.s,map,tree,category='Lifestyle',weight=F); 
pdf("results/wuf.pdf",width=6,height=4.75); pcoa.w = plot_unifrac(otu.s,map,tree,category='Lifestyle',weight=T); 
graphics.off()
